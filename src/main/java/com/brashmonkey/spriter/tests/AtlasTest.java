...
import org.jocean.gdx.spriter.LibGdxAtlasLoader;
...
public class AtlasTest extends ApplicationAdapter{
	...
	public void create(){
		...
		this.loader = new LibGdxAtlasLoader(reader.getData(), Gdx.files.internal("monster/monster.atlas"));
		//this.loader = new LibGdxLoader(reader.getData());
		this.loader.load("monster");
		System.out.println(System.currentTimeMillis()-time);
		
		this.drawer = new LibGdxDrawer(loader, batch, null);
